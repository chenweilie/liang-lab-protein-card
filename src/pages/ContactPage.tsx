            ...
            <div className="bg-navy-950 text-white py-24 md:py-32 mb-16 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 max-w-5xl relative z-10">
                    <div className="max-w-3xl">
                        <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-6 drop-shadow-lg">Contact</h1>
                            ...
                            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 shadow-sm">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-center gap-2">
                                        ...
                                        <span className="font-medium text-gray-800">+65 6592 7736</span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        <span className="font-medium text-gray-800">Fax: +65 6791 3856</span>
                                    </li>
                                </ul>
                            </div>
                        </section>
